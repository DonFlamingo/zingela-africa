            ...
            <div id="reports-form-reports" class="tab-pane active">
                ...
                <div class="row form-horizontal">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="to" class="col-sm-3 control-label">{!!trans('front.drivers')!!}</label>
                            {!! Form::hidden('driver_fake') !!}
                            <div class="col-sm-9">
                                {!!Form::select('driver', $drivers, null, ['class' => 'form-control',  'data-icon' => 'icon account', 'data-live-search' => true, 'data-actions-box' => true])!!}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        if ( typeof _static_reports_create === "undefined") {
            ...
            $(document).on('click', '#reports_create .report_item_edit', function() {
                ...
                var drivers = [];
                $.each(item.drivers, function( index, value ) {
                    drivers.push( value.id );
                });
                $('#report_form select[name="drivers[]"]').val( drivers ).trigger('change').selectpicker('refresh');
                dd( 'drivers', drivers );
            ...
            $(document).on('change', '#reports_type', function() {
                ...
                switch (val) {
                    ...
                    case "18":
                        ...
                        break;
                    case "23":
                        parent.find('select.driver, select.reports_geofences, input[name="speed_limit"], select[name="stops"], input[name="show_addresses"], input[name="zones_instead"]').attr('disabled', 'disabled');
                    break;
                }
